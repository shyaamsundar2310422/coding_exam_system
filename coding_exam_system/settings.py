...
import mongoengine
MONGODB_HOST = os.getenv('MONGODB_HOST', 'mongodb+srv://shyaamsundar2310422_db_user:IFP123$$@cluster0.8jdoj1f.mongodb.net/')
...
try:
    ...
    print("⚠️  Continuing with SQLite database")
